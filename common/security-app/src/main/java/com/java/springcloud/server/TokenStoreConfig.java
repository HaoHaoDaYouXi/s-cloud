...
public class TokenStoreConfig {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "cloud.security.oauth2", name = "tokenStore", havingValue = "redis")
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "cloud.security.oauth2", name = "tokenStore", havingValue = "jwt", matchIfMissing = true)
