package com.java.springcloud.constant;
...
public class GlobalConstant {
    ...
    public static final String ROOT_PREFIX = "123456";
    ...
    public static final class Sys {
         ...
         * 超级管理员的用户编号
         */
        public static final String SUPER_MANAGER_LOGIN_NAME = "system";
        /**
         * 超级管理员角色ID
         */
    ...
    public static final class Oss {
         ...
         * The constant DEFAULT_FILE_PATH.
         */
        public static final String DEFAULT_FILE_PATH = "/data/default/";
    }
