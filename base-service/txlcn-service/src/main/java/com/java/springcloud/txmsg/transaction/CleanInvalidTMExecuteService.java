...
import com.java.springcloud.core.storage.FastStorage;
...
public class CleanInvalidTMExecuteService implements RpcExecuteService {
    ...
    private static final TxLogger txLogger = TxLogger.newLogger(com.java.springcloud.txmsg.transaction.CleanInvalidTMExecuteService.class);
