 ...
 */
package com.java.springcloud.support.restapi.auth.sauth.token;

import com.java.springcloud.support.restapi.auth.sauth.SAuthLogic;
import com.java.springcloud.support.restapi.auth.sauth.SAuthHandleException;
import com.java.springcloud.support.restapi.auth.sauth.SAuthLogic;
import com.java.springcloud.support.restapi.vo.ErrorResponse;
...
public class TokenInterceptor implements HandlerInterceptor {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(com.java.springcloud.support.restapi.auth.sauth.token.TokenInterceptor.class);
