 ...
 */
package com.java.springcloud.core;

import com.codingapi.txlcn.common.exception.TransactionException;
import com.codingapi.txlcn.logger.TxLogger;
import com.java.springcloud.core.storage.TransactionUnit;
import com.java.springcloud.support.service.TxExceptionService;
import com.java.springcloud.txmsg.MessageCreator;
import com.java.springcloud.txmsg.RpcExceptionHandler;
import com.java.springcloud.core.DTXContext;
import com.java.springcloud.core.DTXContextRegistry;
import com.java.springcloud.core.TransactionManager;
import com.java.springcloud.core.storage.TransactionUnit;
import com.java.springcloud.support.service.TxExceptionService;
import com.java.springcloud.txmsg.MessageCreator;
import com.java.springcloud.txmsg.RpcExceptionHandler;
...
public class SimpleTransactionManager implements TransactionManager {
    ...
    private static final TxLogger txLogger = TxLogger.newLogger(com.java.springcloud.core.SimpleTransactionManager.class);
