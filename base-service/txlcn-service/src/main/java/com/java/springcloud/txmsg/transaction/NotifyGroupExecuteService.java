 ...
 */
package com.java.springcloud.txmsg.transaction;
...
import com.java.springcloud.txmsg.RpcExecuteService;
import com.java.springcloud.txmsg.TransactionCmd;
...
public class NotifyGroupExecuteService implements RpcExecuteService {
    ...
    private static final TxLogger txLogger = TxLogger.newLogger(com.java.springcloud.txmsg.transaction.NotifyGroupExecuteService.class);
